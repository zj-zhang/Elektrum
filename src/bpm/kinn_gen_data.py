...
"""@package docstring
File: kinn_gen_data.py
Author: Adam Lamson
Email: alamson@flatironinstitute.org
Description: Generate data to test KA and eigen function generation
"""
...
class KineticModel():
    ...
    def get_mutated_seqs(self, npoints, mut_num=None):
        ...
        if isinstance(mut_num, list):  # Vary the number of mutations per seq
